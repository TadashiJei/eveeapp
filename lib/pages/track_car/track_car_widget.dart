...
class TrackCarWidget extends StatefulWidget {
  const TrackCarWidget({super.key});
...
class _TrackCarWidgetState extends State<TrackCarWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'trackCar'});
                ...
                children: [
                  Expanded(
                    child: Builder(builder: (context) {
                      final googleMapMarker = trackCarProductNameRecord;
                        ...
                        markers: [
                          if (googleMapMarker != null)
                            FlutterFlowMarker(
                              ...
                              googleMapMarker.productLocation!,
                            ),
                        ],
                  ...
                  children: [
                    Card(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'TRACK_CAR_arrow_back_rounded_ICN_ON_TAP');
