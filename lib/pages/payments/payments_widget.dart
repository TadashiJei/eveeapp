            ...
            children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'PAYMENTS_PAGE_PAY_EARLY_BTN_ON_TAP');
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('PAYMENTS_PAGE_Container_zkn5hcmc_ON_TAP');
              ...
              FutureBuilder<List<PaymentsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return RefreshIndicator(
                    onRefresh: () async {
                      logFirebaseEvent(
                          'PAYMENTS_ListView_jsla2mln_ON_PULL_TO_RE');
                      ...
                      itemBuilder: (context, listViewIndex) {
                        ...
                        return Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PAYMENTS_PAGE_Container_2llt4yft_ON_TAP');
                              logFirebaseEvent('Container_navigate_to');
