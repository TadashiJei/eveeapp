...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'addCar',
          path: '/addCar',
          builder: (context, params) => const AddCarWidget(),
        ),
        FFRoute(
          name: 'forgotPassword',
          path: '/forgotPassword',
        ...
        FFRoute(
          ...
          builder: (context, params) => const CarDrivingParkedWidget(),
        ),
        FFRoute(
          name: 'carDriving',
          path: '/carDriving',
          builder: (context, params) => const CarDrivingWidget(),
        ),
        FFRoute(
          name: 'pastPayment',
          path: '/pastPayment',
          builder: (context, params) => const PastPaymentWidget(),
        ),
        FFRoute(
          name: 'services',
          path: '/services',
        ...
        FFRoute(
          ...
          path: '/payments',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'payments')
        ...
        FFRoute(
          name: 'trackCar',
          path: '/trackCar',
          builder: (context, params) => const TrackCarWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const CreateAppointmentWidget(),
        ),
        FFRoute(
